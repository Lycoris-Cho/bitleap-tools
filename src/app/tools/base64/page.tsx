...
export default function Base64Page() {
  ...
  // 编码：先 encodeURIComponent 处理 UTF-8，再 btoa
  const encoded = (() => {
  ...
  // 解码：先 atob，再 decodeURIComponent 还原 UTF-8
  const decoded = (() => {
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-10">
      <Breadcrumb />
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Base64 编解码</h1>
        <p className="text-app-muted text-sm">文本与 Base64 互转，支持中文与 UTF-8 字符，实时转换</p>
      </div>
      ...
      <div className="space-y-4">
        <textarea
          ...
          placeholder={mode === 'encode' ? '输入待编码文本...' : '输入 Base64 字符串...'}
...
{output}
      ...
      <div className="mt-10 p-4 bg-gray-50 border border-app-border rounded-xl">
        ...
        <ul className="text-xs text-app-muted space-y-1.5 leading-relaxed">
          <li>• 编码：文本 → Base64；解码：Base64 → 文本，切换上方按钮选择方向</li>
